            ...
            <div className="container">
                ...
                <div className="grant__container">
                    ...
                    <img className='grant__img' src={gks} alt="" />
                        <h1 className='grant__title'>GKS (Global Korean Scholarship) - <span className='grey'>$70.000</span> lik Grant</h1>
                        ...
                        <p className='grant__lowertext'> Dastur boshlanganida va tugaganida Koreyaga borish hamda Koreyadan qaytish xarajatlari qoplanadi.
                            ...
                            Til kursi va universitetning kontrak to'lovi to'liq to'lab beriladi (faqat magistr va doktorantlarga)... <span className='grey'>ko’proq</span></p>
                    </div>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/rXfNtl6yimw?si=PoSDP4aQSib47pQs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
